...
(function () {
  function initBonusOffersSliders() {
    var roots = document.querySelectorAll("[data-bonus-offers-slider]");
    roots.forEach(function (root) {
      var carousel = root.querySelector("[data-bonus-offers-slider-carousel]");
      if (!carousel) {
        return;
      }
      var paginationEl = carousel.querySelector('.swiper-pagination');
      var prevBtn = carousel.querySelector('.swiper-button-prev');
      var nextBtn = carousel.querySelector('.swiper-button-next');
...
(function () {
  function initCasinoFaq() {
    var roots = document.querySelectorAll("[data-casino-faq]");
    roots.forEach(function (root) {
      var toggles = root.querySelectorAll("[data-casino-faq-toggle]");
      toggles.forEach(function (btn) {
        btn.addEventListener("click", function () {
          var item = btn.closest("[data-casino-faq-item]");
          var panel = item ? item.querySelector("[data-casino-faq-panel]") : null;
          if (!item || !panel) {
            return;
          }
...
/***/ "./src/js/casino-overview-card.js":
/*!****************************************!*\
  !*** ./src/js/casino-overview-card.js ***!
  \****************************************/
/***/ (() => {
...
(function () {
  function initCasinoOverviewCards() {
    var roots = document.querySelectorAll("[data-casino-overview]");
    roots.forEach(function (root) {
      var shell = root.querySelector("[data-casino-overview-body]");
      var toggles = root.querySelectorAll("[data-casino-overview-toggle]");
...
(function () {
  ...
  document.addEventListener("click", function (ev) {
    ...
    if (opener) {
      ...
      var target = document.querySelector('[data-modal-shell-instance="' + inst.replace(/"/g, '\\"') + '"]');
      if (!target) {
        return;
      }
      ev.preventDefault();
  ...
  window.openModalShell = function (instance) {
    ...
    var el = document.querySelector('[data-modal-shell-instance="' + String(instance).replace(/"/g, '\\"') + '"]');
    if (!el) {
      return;
    }
    openModalShell(el);
...
__webpack_require__(/*! ./bonus-offers-slider */ "./src/js/bonus-offers-slider.js");
__webpack_require__(/*! ./casino-overview-card */ "./src/js/casino-overview-card.js");
__webpack_require__(/*! ./casino-faq */ "./src/js/casino-faq.js");
__webpack_require__(/*! ./modal-shell */ "./src/js/modal-shell.js");
__webpack_require__(/*! ./sidebar-toc */ "./src/js/sidebar-toc.js");
__webpack_require__(/*! ./user-reviews */ "./src/js/user-reviews.js");
__webpack_require__(/*! ./at-a-glance */ "./src/js/at-a-glance.js");
document.addEventListener('DOMContentLoaded', function () {
  var casinoSliders = document.querySelectorAll('.casino-card--bonuses');
  casinoSliders.forEach(function (sliderElement, index) {
    var paginationEl = sliderElement.querySelector('.swiper-pagination');
...
document.addEventListener('DOMContentLoaded', function () {
  var textBlock = document.querySelector('.home--intro-text');
  var toggleBtn = document.querySelector('.home--intro-switch');
...
(function () {
  var btn = document.querySelector('.header--menu-open');
  if (btn) {
...
(function () {
  var faq_items = document.querySelectorAll('.faq--title');
  if (faq_items) {
    faq_items.forEach(function (title) {
...
function goButtonRedirect() {
  document.addEventListener('click', function (event) {
    ...
    var encodedUrl = button.dataset.go;
    var decodedUrl = atob(encodedUrl.toString());
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.casino-card--payment-items').forEach(function (container) {
    var isDown = false;
    var startX = 0;
    var scrollLeft = 0;
...
function initTableScrollInSpaceContent() {
  ...
  document.querySelectorAll('.table_scroll').forEach(function (block) {
    var viewport = block.querySelector('.table_scroll__viewport');
    var track = block.querySelector('.table_scroll__track');
    var thumb = block.querySelector('.table_scroll__thumb');
    ...
    var syncThumb = function syncThumb() {
      var _metrics = metrics(),
        sw = _metrics.sw,
        cw = _metrics.cw,
        tw = _metrics.tw,
        maxScroll = _metrics.maxScroll;
      if (!sw || !cw) {
        return;
      }
      if (sw <= cw) {
      ...
      var minPct = tw > 0 ? MIN_THUMB / tw * 100 : 0;
      var thumbW = Math.max(cw / sw * 100, minPct);
      var leftPct = maxScroll > 0 ? viewport.scrollLeft / maxScroll * (100 - thumbW) : 0;
    ...
    document.addEventListener('mousemove', function (e) {
      ...
      e.preventDefault();
      var _metrics2 = metrics(),
        maxScroll = _metrics2.maxScroll,
        thumbPx = _metrics2.thumbPx,
        tw = _metrics2.tw;
      var travel = Math.max(tw - thumbPx, 1);
      var delta = (e.clientX - dragStartX) / travel * maxScroll;
    ...
    track.addEventListener('mousedown', function (e) {
      ...
      var _metrics3 = metrics(),
        maxScroll = _metrics3.maxScroll;
      if (maxScroll <= 0) {
        return;
      }
    ...
    requestAnimationFrame(function () {
      return requestAnimationFrame(syncThumb);
    });
    if (typeof ResizeObserver !== 'undefined') {
      var ro = new ResizeObserver(syncThumb);
      ro.observe(viewport);
      var tableEl = viewport.querySelector('table');
      if (tableEl) {
        ro.observe(tableEl);
      }
    }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var sticky = document.querySelector('.space-organization-float-bar-bg');
  var closeBtn = document.querySelector('.casino-review-split-banner__close-btn');
  if (sticky) {
